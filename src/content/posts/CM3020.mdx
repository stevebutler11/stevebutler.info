...
How can we create an AI that can play games? Most games involve an iterative process of observing and acting. Most games involve some sort of positive or negative result. Think of an arcade game:
...
The reason it is stochastic is that the ball can be moving in any direction, and a snapshot of the screen (state) does not indicate which direction the ball is moving. You can read the above expression as '_probability of state prime, given state and action_'
...
_What happened after the Atart 2015 paper by deepmind?_

A number of improvements were made and released, including:
- [doubleDQN](https://ojs.aaai.org/index.php/AAAI/article/view/11796)
- [DreamerV2](https://arxiv.org/abs/2010.02193)
- [R2D2](https://iclr.cc/Conferences/2019/Schedule?showEvent=648)
- [Agent57](https://arxiv.org/abs/2003.13350)

the latter achieving super-human performance across all 57 atari games.

DeepMind have since released AlphaStar, which is an AI capable of playing the game StarCraft and StartCraft 2. These games are considerably more complex than the boardgame go for which DeepMind has already solved.

OpenAI have released OpenAI Five, which is a game playing AI for the game DOTA. It has beaten professional players, and a website was set up to give the public the ability to compete against it. OpenAI Five won 7215 times and lost only 42 times.

#### Ethics of game playing AI

An extreme view of fairness in game playing is quoted below:

> “a completely fair competition can only be achieved against an artificial system that is essentially equivalent to a flesh and blood human”  
> __M. Canaan, C. Salge, J. Togelius, and A. Nealen. Leveling the playing field-fairness in ai versus human game benchmarks. arXiv preprint arXiv:1903.07008, 2019.__

In the paper they come up with six dimensions of fairness to consider for competition:
...
A more moderate view can be found in the 2019 paper [When are we done with games?]()

> “Through the discussion of two areas (the competitors perceptual and motoric abilities; and the game’s extrinsic and intrinsic factors) we hope to show that, so far, no fair competition between AIs and human has occurred in Dota 2 and StarCraft II … We thus conclude that we are not done with games.”  
> __When Are We Done with Games? 2019__

In the DeepMind documentary on AlphaGo, on the one hand the commentator says:

> “The lessons that alphago is teaching us are going to influence how go is played for the next 1000 years"

meaning the game playing AI has lled to new discoveries, and uncovered novel ways to play the game. In the other hand, the top player Lee Sedol has since retired from the sport, citing:

> "I'm not at the top even if I become the number one."

## Evolving creature

### Week 6: Automatic design using genetic algorithms

This topic focuses on genetic algorithms. Genetic algorithms are a branch of bio-inspired computing, which is a branch of artificial intelligence.  
We'll use genetic algorithms to design robotic forms, re-implementing a famous research paper by Karl Sims.

This case study is organised into five weeks of content:  
Week 6: Introduction to automatic design using genetic algorithms  
Week 7: Building robots using pybullet and URDF files  
Week 8: Genetic encoding scheme  
Week 9: Simulation and fitness function  
Week 10: State of the art in evolutionary computing  

#### Bio-inspired computing

What does bio-inspired mean?
...
__1950s__: Cybernetics  
__1960s__: Connectionism (yes neural networks)  
__1970s__: Genetic algorithms  
__1980s__: Artificial life  
__1990s__: Onwards and upwards!  

##### Cybernetics

> “the science of control and communication, in the animal and the machine”  
> __Norbert Weiner 1948__

The word cybernetics is derived from the greek word for steersman.  
It's focus is control and communication, and not so much about form. It's not really about studying what's out there in nature, what it looks like, what color it is, how many legs it's got etc. It's much more about how it _works_, how it _functions_, how it _controls itself_, and how the different entities might communicate with each other or different parts of an entity might effectively communicate with each other.

> “Co-ordination, regulation and control will be its themes, for these are of the greatest biological and practical interest”  
> __Ross Ashby 1961__

There is a nice article regarding british cybereticism: "Cybernetics and the mangle: Ashby, Beer and Pask." Social studies of science 32.3 (2002): 413-437.

##### Connectionism

> “The perceptron is a minimally constrained "nerve net" consisting of logically simplified neural elements, which has been shown to be capable of learning to discriminate and to recognize perceptual patterns”  
> __F. Rosenblatt, "Perceptron Simulation Experiments," Proceedings of the IRE, vol.48, no.3, pp.301-309, March 1960__

Rosenblatt is credited with inventing the perceptron.  
This is the birth neural networks, which has led to deep neural networks and the recent boom in AI. 

##### Artificial life

In the 1980s, Chris Langton set up the Artificial Life conference.  
Artificial life is concerned with the simulation of evolution, bio-primordial chemistry, completely artificial complex systems and more.

#### evolution theory crash course

We will be looking at a particular field of bio-inspired computing called genetic algorithms. They are inspired by evolution theory an so it pays dividends to have an understanding of this.

Darwinian theory posits that a population has __variety__ and __heredity__. The population undergoes sorts of tests (__selection__) and the survivors of selection go on to reproduce and pass on their characteristics.
...
The DNA code has 4 distinct letters. A, C, G and T. DNA strands are combinations of these letters strung together. Above that, we have three letter codons. Each three letter codon in the string maps to an amino acid (there are 21 different amino acids).  
Proteins are made of amino acid sequences folded into 3D shapes. They way the DNA is oriented in space (the way it folds) is based on the permutation of amino acids and their interaction with each other (e.g. electrostatic properties). Proteins make up an organism's core structure and function. They also can control the DNA expression pattern.

__NB: watch the evolution theory crash course video by MYK as the notes above are are based on that, but tough to explain__

also, [this](https://www-users.york.ac.uk/~gt3/Lectures/images/YCS-2008-425.pdf) is a good primer on evolution for computer scientists

#### Artificial evolution and genetic algorithms

John Holland (Uni. Michigan) invented the idea of genetic algorithms in the 1960s. Genetic algorithms are:

> probabilistic search procedures designed to work on large spaces involving state that can be represented by strings  
> __Goldberg, David E., and John H. Holland. "Genetic Algorithms and Machine Learning." Machine Learning 3.2-3 (1988): 95-99__

but how does this relate to evolution theory?

probabilistic search = _selection_  
states = _phenotypes_  
strings = _genotypes_  

We define space as the space of possible solutions to a problem. So if we can search the space, we can find a solution to a problem. Examples of problems include:
- What is the ideal shape for an aeroplane wing?
- What are the ideal settings for this data centre to reduce power consumption?
- What is the most efficient robot form for walking?

moving forward, we'll use the first example of an aeroplane wing

##### encoding: genotypes

we need to encode the ‘solutions’ or ‘states’ somehow, normally as a string of numbers or bits. This is the genetic encoding. It is similar to how DNA encodes proteins.  
The encoding provides a manipulable representation of the solution. A possible solution is seen below:

<div style="display: flex; flex-direction: row; justify-content: center; align-items: center; ">
  <img src="../../../public/assets/cm3020/encoding.png" />
</div>

Once we have our encoding, we need to decode it to see how ‘good’ this solution is. Depending on the problem, we might then need to run the decoded solution in simulation to see how good it is, or run some other tests against them.  
In the aeroplane example, this might involve using a physics simulation to calculate the lift of each wing, and give the wings with higher lift values better scores.  
This is the _fitness function_.

The next step is to make the next generation. Much like evolution, genetic algorithms are iterative processes, and so parents need to be selected. There are different ways to select, two examples of which are:

Roulette wheel:
- the large the fitness function score, the greater the size of segment on the roulette wheel
- the greater the wheel size, the greater chance of breeding

Tournament selection:
- each solution is compared to each other solution and the fittest gets to breed

Once the sets of parents are selected, they need to be combined in some way.  
The typical breeding process involves _crossover_ and _mutation_.  
Crossover involves taking part of one parent, part of the other, and combining them. This can be done in different ways e.g. one-point crossover, multi-point crossover.

<div style="display: flex; flex-direction: row; justify-content: center; align-items: center; ">
  <img src="../../../public/assets/cm3020/crossover.png" />
</div>

Mutation involves randomly choosing places on the encoding an flipping the bits:

<div style="display: flex; flex-direction: row; justify-content: center; align-items: center; ">
  <img src="../../../public/assets/cm3020/mutation.png" />
</div>

This whole process is repeated many times, until we are left with a population of really good solutions for aeroplane wings. 

#### Why genetic algorithms work

##### local and global maximum

A local maximum denotes a point in the search space where a solution seems optimal within a limited neighborhood but may not be the best globally. This scenario can trap the algorithm in suboptimal solutions.  
On the other hand, a global maximum represents the ultimate best solution across the entire search space. Striking a balance between exploration (diverse search) and exploitation (focused refinement) strategies is essential to prevent algorithms from converging prematurely to local maxima, thereby enhancing the chances of discovering the true global maximum for a given problem.  
Genetic algorithms aim to solve this problem.

##### hyperplane sampling

In a nutshell, hyperplane sampling is breaking a solution into components to test those components in multiple combinations with other components.

__Schema theorem__

Schemas are patterns, like a simple regular expression. An example of a schema for a space of binary strings:  
1**0 : all 4 bit strings that start with a 1 and end with a 0, e.g. 1000, 1110 etc.  
The hyperplane _covers the set of coordinates matching the schema_. So schema theorem is used in conjunction with hyperplane sampling to create 'hyperplanes' to break apart solutions and test them.

Let's say we are evolving designs for a drone propeller/rotor setup. The first part of the genetic encoding might represent the cross section of the blade, and the rest defines how many rotors there are, how big they are, etc. Say we have a schema like: 100100********... -> this defines a hyperplane of rotors with a certain cross section but with anything for the other characteristics of the rotor. So by exploring that hyperplane we test out that particular cross section with all other possible options for the design.

##### implicit parallelism

In a nutshell, using a population model to maintain, optimise and even recombine multiple solutions at the same time.

The genetic algorithm has a population model. This means that multiple ‘blood lines’ might exist in the population. This is what is meant by parallelism – we are not just optimising a single solution, we are optimising multiple solutions simultaneously.

##### computational parallelism

It's worth noting that genetic algorithms lend themselves to being computed in parallel, e.g. assessing multiple solutions at the same time on a multi-processor system.

#### Karl Sims creatures

Watch MYK's video on Karl Sims creatures for an overview of how he used genetic algorithms
...
Three phases:
1. start with population with varied heredity
2. some sort of test applied (selection)
...
> __Harvey, Inman. "The microbial genetic algorithm." European conference on artificial life. Springer, Berlin, Heidelberg, 2009__

##### Phenotype

We will roughly follow Sims, but with simplifications. We’ll use [URDF](http://wiki.ros.org/urdf) format to specify our phenotype, this will be automatically generated in accordance with out genotype.

##### Simulation

[pybullet](https://pybullet.org/wordpress/) will be used for the physics simulation

##### Genotype

Again, we’ll follow Sims somewhat, but with simplifications.

##### Fitness function

The fitness function will basically be: 'how far does it move?'. Bearing in mind that GA's have a tendency to cheat by finding loopholes in physics simulations.

##### Pupulation model

We'll use the roulette wheel selection model described earlier.

##### Compute in parallel

We'll design the system with explicit parallelism.

#### Introduction to pybullet

pybullet is based on the bullet rigid and soft body physics engine. The python bindings have improvements added for robotics, reinforcement learning and VR.

MYK shows how to install using a venv, installing the relevant packages: pybullet, ipython (MYK's preferred ide), and numpy

```python
import pybullet as p

# connect to a simulation environent,
# specifying the type of environment
p.connect(p.GUI)
```

#### Creating things in the world

Pybullet separates the look of a shape from the way it behaves when colliding. This way you can specify the type of collision detection (e.g. bouding box) so as to control the amount of computational complexity needed.

##### adding a floor

first you need to specify the geometry of the shape, before the shape can be created. The geometry will then be used twice, once for the collision and one for the visual:
...
# use floor_shape twice for visual and collison geometry
floor = p.createMultiBody(floor_shape, floor_shape)
```

##### Get a shape on screen
...
Unified Robot Description Format (URDF) is an XML based file format for specifying robot models, including their motors and other dynamics. Tutorials can be found [here](http://wiki.ros.org/urdf/Tutorials/Building%20a%20Visual%20Robot%20Model%20with%20URDF%20from%20ScratchA)

##### why use URDF?

Programmatically generating models is overly complex. Also we more easily share models if we have a standardised format.

##### loading a pre-made URDF model

pybullet comes with some standard URDF models already built in. You can access them in the folder:
...
you can then load the model like below:
...
#### Write a URDF file from scratch

Watch MYK's video on writing a URDF file.

#### Moving a URDF file

There are three types of joint in pybullet (there's more that can be used in a URDF file, but pybullet currently only supports the three 1 dof joints). The joints are:
- revolute (rotate)
- prismatic (move along a axis)
- fixed (does not move)

##### moving the joint in a two link robot
...
p.connect(p.GUI)
p.setPhysicsEngineParameter(enableFileCaching=0) # this needs to be set when editing URDF files else changes won't be seen
p.configureDebugVisualizer(p.COV_ENABLE_GUI, 0) # hides side bars in GUI
...
p.setMotorJointControl2(rob1, 0, controlMode=p.VELOCITY_CONTROL, targetVelocity=5) 
```

__N.B. read the lab sheet for this week__

### Week 8: 

Watch the lecture videos this week as MYK goes in depth on creating URDF files from randomised gene data. The lab sheets can be seen below and also the accompanying code.
...
#### Creatures code for week 8

Code for this week can be found [here](https://github.com/stevebutler11/creatures)


## AI and creativity

### Week 11: Introduction to generative systems

#### Introduction to generative systems

passive tool: doesn't do anything of it's own accord (e.g. paintbrush)
active tool: proccesses what the user is doing and tries to interpret it and add to it. 'fill in the blanks' (e.g. sketchRNN, DALL-E, Conway's game of life)

##### Taxonomies of creative systems
Boden and edmonds came up with 11, three of which are below:

2. C-art uses computers as part of the art-making process (e.g. any computer based drawing app, or sketchRNN, DALL-E etc)
5. G-art works are generated, at least in part, by some process that is not under the artist's direct control (e.g. sketchRNN, Dall-E, Game of Life)
6. CG-art is produced by leaving a computer program to run by itself, with minimal or zero interference from a human being (e.g. DALL-E)

##### Features
Tatar and Pasquier came up with common features to differentiate generative systems (their research is mainly based on music systems):
- System Architecture
- Number of agents
- Roles
- Environment (live performance, offline)
- Corpus (what's it been trained on)
- Input
- Output
- Communication (how does it communicate with itself and a human)
- Human Interactivity Modality (how does the human interact with the thing)
- Task
- Evaluation

### Worked example of a generative system

Start witn a word sequence: “the problem with the pop music industry is the music”
Let’s convert that into a first order Markov model by making a state transition table:
...
##### second order model
A second order model would look like:
...
A higher order leads to a less rich model as it limits how many different observations there are.
Also, the more text you feed a markov model, the richer the model becomes
...
#### Coding up a Markovian text generator and training it

```python
import random

input = "once upon a time there was a man who was never on time ever"
...
### Week 12: Generating lyrics with GPT-2
